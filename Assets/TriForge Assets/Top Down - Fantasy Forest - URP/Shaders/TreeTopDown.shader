	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 texCoord53 = v.texcoord1.xyzw.xy * float2( 1,1 ) + float2( 0,0 );
				half3 worldToObjDir94 = normalize( mul( GetWorldToObjectMatrix(), float4( _WindAxisXZ, 0 ) ).xyz );
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				half2 panner82 = ( ( _TimeParameters.x * 1.0 ) * float2( 0.12,0 ) + (( ase_worldPos / ( -80.0 * _WindNoiseScale ) )).xz);
				half simplePerlin3D80 = snoise( half3( panner82 ,  0.0 )*3.0 );
				simplePerlin3D80 = simplePerlin3D80*0.5 + 0.5;
				half2 panner102 = ( ( _TimeParameters.x * 0.6 ) * float2( -0.1,0.1 ) + (( ase_worldPos / ( -80.0 * _WindNoiseScale ) )).xz);
				half simplePerlin3D97 = snoise( half3( panner102 ,  0.0 )*6.0 );
				simplePerlin3D97 = simplePerlin3D97*0.5 + 0.5;
				half blendOpSrc110 = simplePerlin3D80;
				half blendOpDest110 = simplePerlin3D97;
				half lerpBlendMode110 = lerp(blendOpDest110,( blendOpSrc110 * blendOpDest110 ),0.76);
				half3 rotatedValue59 = RotateAroundAxis( half3(0,0,0), v.vertex.xyz, normalize( worldToObjDir94 ), radians( ( (-0.4 + (( saturate( lerpBlendMode110 )) - 0.0) * (0.6 - -0.4) / (1.0 - 0.0)) * 30.0 ) ) );
				...
				#endif
				float3 vertexValue = ( ( half3( texCoord53 ,  0.0 ) * ( rotatedValue59 - v.vertex.xyz ) ) * _WindStrength );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half4 temp_output_47_0 = ( ( tex2DNode1 * _Color ) * _MainTextureBrightness );
				half3 desaturateInitialColor46 = temp_output_47_0.rgb;
				half desaturateDot46 = dot( desaturateInitialColor46, float3( 0.299, 0.587, 0.114 ));
				half3 desaturateVar46 = lerp( desaturateInitialColor46, desaturateDot46.xxx, 0.25 );
				half2 texCoord7 = IN.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				half4 lerpResult32 = lerp( temp_output_47_0 , half4( ( desaturateVar46 * _TopBrightness ) , 0.0 ) , saturate( pow( texCoord7.y , 2.93 ) ));
				...
				float3 Albedo = ( lerpResult32 * 1.0 ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0.0;
				float Smoothness = ( tex2D( _Metallic, uv_Metallic ).a * _Smoothness );
				float Occlusion = 1;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				half2 texCoord53 = v.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				half3 worldToObjDir94 = normalize( mul( GetWorldToObjectMatrix(), float4( _WindAxisXZ, 0 ) ).xyz );
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				half2 panner82 = ( ( _TimeParameters.x * 1.0 ) * float2( 0.12,0 ) + (( ase_worldPos / ( -80.0 * _WindNoiseScale ) )).xz);
				half simplePerlin3D80 = snoise( half3( panner82 ,  0.0 )*3.0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half2 texCoord53 = v.texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				half3 worldToObjDir94 = normalize( mul( GetWorldToObjectMatrix(), float4( _WindAxisXZ, 0 ) ).xyz );
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				half2 panner82 = ( ( _TimeParameters.x * 1.0 ) * float2( 0.12,0 ) + (( ase_worldPos / ( -80.0 * _WindNoiseScale ) )).xz);
				half simplePerlin3D80 = snoise( half3( panner82 ,  0.0 )*3.0 );
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half desaturateDot46 = dot( desaturateInitialColor46, float3( 0.299, 0.587, 0.114 ));
				half3 desaturateVar46 = lerp( desaturateInitialColor46, desaturateDot46.xxx, 0.25 );
				half2 texCoord7 = IN.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				half4 lerpResult32 = lerp( temp_output_47_0 , half4( ( desaturateVar46 * _TopBrightness ) , 0.0 ) , saturate( pow( texCoord7.y , 2.93 ) ));
...
/*ASEBEGIN
Version=18700
1920;0;1920;1019;7818.91;2386.488;6.039233;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-4281.971,2045.849;Inherit;False;Property;_WindNoiseScale;Wind Noise Scale;8;0;Create;True;0;0;False;0;False;1;0.3;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;154;-2586.244,-1474.478;Inherit;False;Property;_Color;Color;9;0;Create;True;0;0;False;0;False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-2585.016,-1671.917;Inherit;True;Property;_MainTex;Base Color;0;0;Create;False;0;0;False;0;False;-1;None;1c53b8ebd1501144dae80a4b1f0d4939;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-2468.529,-1308.266;Inherit;False;Property;_MainTextureBrightness;Main Texture Brightness;4;0;Create;True;0;0;False;0;False;0.5;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;65;-2554.455,1349.107;Inherit;False;Property;_WindAxisXZ;Wind Axis (X, Z);7;0;Create;True;0;0;False;0;False;0,0,1;0,0,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1962.872,-1308.492;Inherit;False;Property;_TopBrightness;Top Brightness;5;0;Create;True;0;0;False;0;False;3;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;146;-443.1703,1153.876;Inherit;False;Property;_WindStrength;Wind Strength;6;0;Create;True;0;0;False;0;False;0.5;1.24;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;3;-820.8923,261.0659;Inherit;True;Property;_Metallic;Metallic;2;0;Create;True;0;0;False;0;False;-1;None;b42c554872f39844b8922d5451577f49;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-869.6678,-18.8577;Inherit;True;Property;_Normal;Normal;1;0;Create;True;0;0;False;0;False;-1;None;9e7f8850ed9218b4aaacdea31bd279d9;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;162;-310.6572,199.3784;Inherit;False;Constant;_Float7;Float 7;11;0;Create;True;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;4;-449.6109,401.6013;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;5;-840.2924,513.3057;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;False;0;False;0;0.132;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;163;-304.1496,114.8879;Inherit;False;Constant;_Float8;Float 8;10;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;156;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;161;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;158;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;159;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;160;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;157;0,0;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;TriForge/Top Down Tree;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;2;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;0;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
WireConnection;157;0;42;0
WireConnection;157;1;2;0
WireConnection;157;3;163;0
WireConnection;157;4;4;0
WireConnection;157;6;1;4
WireConnection;157;7;162;0
WireConnection;157;8;145;0
ASEEND*/
//CHKSM=9D5D7393475AD00FD12E6F9193511EEC000AE197